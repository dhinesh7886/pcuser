...
.get();
  ...
  // Run weekoff update in background (non-blocking)
  _storeWeekOffSundays();
} catch (e) {
...
0,
  ...
  debugPrint("Error storing week off: $e");
}
...
final snapshot = await FirebaseFirestore.instance
    ...
    .orderBy("timestamp") // ✅ Ensure proper ordering
    .get();

debugPrint("Fetched docs: ${snapshot.docs.length}");
